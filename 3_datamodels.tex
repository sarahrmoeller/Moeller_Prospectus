...
\begin{table*}
    ...
    \begin{tabular}{l|r|r|rc|rc|rc}
         ...
         \hline
         Alas & 4.5k  & 623 & 3,840 & 86\% & 3,775 & 83\% & 3845  & 86\% \\
         ...
         %\hline
         %Arapaho & 300k &  n/a & 202,993 & 68\%  & 202,993 & 68\% &  &  \\
         ...
         \hline
         Lezgi & 14k & 843 & 13,625  & 98\%  & 13,353  &  94\% & 13,636 & 96\%  \\
        ...
        % segmented & glossed: 13353/14175 = 0.942
         ...
         \hline
         Manipuri & 12k  & 3260 & 11,907 & 98\%  & 11,907 & 98\% & 2067 & 17\% \\
        ...
        % segmented & glossed: 11907/12139 = 0.980
         ...
         \hline
         Natügu & 16.5k & 1954 & 14,136 & 86\%  & 13,925 &  84\% & 10,994 & 66\% \\
    ...
    \end{tabular}
    \caption{The total token count ignores multiple word expressions (when parsed as such) as single tokens. Inflected refers to the number of unique inflected forms that can be used to train the inflection task. The percentage and total number of tokens that are segmented or glossed are shown.  The segmentation and glossing task trains on both. The inflection task needs only glossed tokens.}
    \label{tab:data}
\end{table*}
...
The proposed research will use supervised machine learning systems. All have achieved state-of-the-art NLP results in low-resource settings. They include the feature-based Conditional Random Fields and LSTM-based encoder-decoder, and one neural system (Transformer). 
