...
\begin{table}[hb]
    ...
    \begin{tabular}{l|r|rc}
         ...
         % both segs & glossed: 3775/4462 = 0.846
         % surf segmented: 3840
         % canonically segmented: 3840
         % glossed: 3775
         % translated: 302/303
         % words from sentences with every word seg/glossed: 2723/4462 = 0.610
         \hline
        ...
        % segmented & glossed: 13925/16520 = 0.842
         ...
         % words from sentences with every word seg/glossed: 6138/16520 = 0.371
         \hline
         Tsez & 53K & 53,145 & 100\%  \\
